...
const Map = forwardRef(function Map2({ children, theme: themeProp, styles, projection, ...props }, ref) {
  ...
  return /* @__PURE__ */ jsx(MapContext.Provider, { value: contextValue, children: /* @__PURE__ */ jsxs("div", { ref: containerRef, className: "relative w-full h-full", children: [
